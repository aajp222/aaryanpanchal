...
(function () {
  ...
  (function () {
    ...
    var PHOTOS = [
      { src: 'assets/opt/aerial-tower-640.webp', cap: 'Golden hour · 400 ft', note: 'Launched the drone before sunrise for this one. Zero regrets.' },
      { src: 'assets/opt/aerial-hero-640.webp', cap: 'New England, from above', note: 'Fall foliage hits different at altitude.' },
      { src: 'assets/opt/wpi-gameday-640.webp', cap: 'Game day · WPI', note: 'Running sideline media for WPI Athletics.' },
      { src: 'assets/opt/lab-640.webp', cap: 'Lab nights', note: '2 a.m. in the WPI lab. The prototype didn’t care what time it was.' },
      { src: 'assets/opt/demoday-640.webp', cap: 'Demo Day 2025', note: 'The room where EpiSafe stopped being a sketch.' },
      { src: 'assets/opt/event-cover-640.webp', cap: 'On location', note: 'Somewhere between setups.' },
      { src: 'assets/opt/team-2025-640.webp', cap: 'The team + Gompei', note: 'Five engineers and one goat.' },
      { src: 'assets/opt/img-4589-640.webp', cap: 'Prototype, on the bench', note: 'The internal mechanism — real parts, real springs.' },
      { src: 'assets/opt/product-macro-640.webp', cap: 'Macro test shot', note: 'Product photography practice on our own device.' },
      { src: 'assets/opt/aaryan-sga-640.webp', cap: 'Office hours', note: 'Co-Marketing Chair duties: look approachable.' }
    ];
    var z = 10, pols = [];
