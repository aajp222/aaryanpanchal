...
(function () {
  ...
  /* ── NAME-LETTER CURSOR TRAIL ──
     The letters of Aaryan's name spawn along the cursor path, pop in,
     drift and fade — spelling the name out as the pointer moves. */
  var spawnIconBurst=null;
  (function(){
    var NAME='Aaryan Panchal';
    ...
    function spawn(x,y,burst,ang,dist){
      ...
      el.textContent=LETTERS[idx++ % LETTERS.length];
